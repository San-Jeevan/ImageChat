...
CountryToContinent['Alaska'] = 'yellow';
CountryToContinent['NorthWestTerritory'] = 'yellow';
CountryToContinent['Alberta'] = 'yellow';
CountryToContinent['Ontario'] = 'yellow';
CountryToContinent['Greenland'] = 'yellow';
CountryToContinent['Quebec'] = 'yellow';
CountryToContinent['WesternUnitedStates'] = 'yellow';
CountryToContinent['EasternUnitedStates'] = 'yellow';
CountryToContinent['CentralAmerica'] = 'yellow';
CountryToContinent['Peru'] = 'red';
CountryToContinent['Brazil'] = 'red';
CountryToContinent['Venezuela'] = 'red';
CountryToContinent['Argentina'] = 'red';
CountryToContinent['NorthAfrica'] = 'yellow';
CountryToContinent['Egypt'] = 'yellow';
CountryToContinent['Congo'] = 'yellow';
CountryToContinent['EastAfrica'] = 'yellow';
CountryToContinent['SouthAfrica'] = 'yellow';
CountryToContinent['Iceland'] = 'blue';
CountryToContinent['GreatBritain'] = 'blue';
CountryToContinent['WesternEurope'] = 'blue';
CountryToContinent['NorthernEurope'] = 'blue';
CountryToContinent['SouthernEurope'] = 'blue';
CountryToContinent['Scandinavia'] = 'blue';
CountryToContinent['Madagascar'] = 'yellow';
CountryToContinent['Ukraine'] = 'blue';
CountryToContinent['MiddleEast'] = 'green';
CountryToContinent['Afghanistan'] = 'green';
CountryToContinent['Ural'] = 'green';
CountryToContinent['India'] = 'green';
CountryToContinent['Siam'] = 'green';
CountryToContinent['China'] = 'green';
CountryToContinent['Mongolia'] = 'green';
CountryToContinent['Irkutsk'] = 'green';
CountryToContinent['Yakutsk'] = 'green';
CountryToContinent['Siberia'] = 'green';
CountryToContinent['Kamchatka'] = 'green';
CountryToContinent['Japan'] = 'green';
CountryToContinent['Indonesia'] = 'blue';
CountryToContinent['NewGuinea'] = 'blue';
CountryToContinent['WesternAustralia'] = 'blue';
CountryToContinent['EasternAustralia'] = 'blue';
